...
abstract class $LoginStateCopyWith<$Res> {
  ...
  $Res call({dynamic loading, dynamic isLoggedIn});
}
...
class _$_LoginState with DiagnosticableTreeMixin implements _LoginState {
  const _$_LoginState({this.loading = false, this.isLoggedIn = false});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginState(loading: $loading, isLoggedIn: $isLoggedIn)';
  }
...
abstract class _LoginState implements LoginState {
  const factory _LoginState({final dynamic loading, final dynamic isLoggedIn}) =
      _$_LoginState;
